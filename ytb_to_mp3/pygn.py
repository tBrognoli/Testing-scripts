...
def createRadio(
    ...
    query.addQueryOption(
        "SELECT_EXTENDED",
        "COVER,REVIEW,ARTIST_BIOGRAPHY,ARTIST_IMAGE,ARTIST_OET,MOOD,TEMPO,LINK",
    )
    query.addQueryOption(
        "SELECT_DETAIL",
        "GENRE:3LEVEL,MOOD:2LEVEL,TEMPO:3LEVEL,ARTIST_ORIGIN:4LEVEL,ARTIST_ERA:2LEVEL,ARTIST_TYPE:2LEVEL",
    )
...
def search(clientID="", userID="", artist="", album="", track="", toc=""):
    ...
    query.addQueryOption(
        "SELECT_EXTENDED",
        "COVER,REVIEW,ARTIST_BIOGRAPHY,ARTIST_IMAGE,ARTIST_OET,MOOD,TEMPO",
    )
    query.addQueryOption(
        "SELECT_DETAIL",
        "GENRE:3LEVEL,MOOD:2LEVEL,TEMPO:3LEVEL,ARTIST_ORIGIN:4LEVEL,ARTIST_ERA:2LEVEL,ARTIST_TYPE:2LEVEL",
    ...
    if responseElem.attrib["STATUS"] == "OK":
        ...
        if artistOriginElem is not None:
            ...
            metadata["artist_origin"], metadata["artist_era"], metadata[
                "artist_type"
            ] = _getOET(clientID, userID, metadata["album_gnid"])
        ...
        for elem in elems:
            if topKey in elem.attrib:
                result[elem.attrib[topKey]] = {
                    bottomKey: elem.attrib[bottomKey],
                    "TEXT": elem.text,
                }
            else:
