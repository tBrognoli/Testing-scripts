...
convert = False"""
    ...
    def create_config(self):
        ...
        try:
            ...
            message = (
                "A new config file created in: %s\n"
    ...
    def read_config(self):
        ...
        try:
            ...
            if config.has_option("Default", "smtp_password"):
                ...
                self.smtp_password = self.smtp_password or config.get(
            ...
            traceback.print_exc()
            message = (
                "Your config file could not be read or contains "
    ...
    def parse_args(self):
        ...
        description = (
            "SendKindle will send any number of files via email "
            "to your Kindle device."
        )
        parser = optparse.OptionParser(
            usage=usage, version=_version, description=description
        )
        self.parser = parser
        parser.add_option(
            "--password",
            help=(
                "Use provided password instead "
        ...
        parser.add_option(
            ...
            default=False,
            help=(
                "Ask Kindle service to convert the documents "
    ...
    def send_mail(self, email=None):
        """Send email with attachments"""

        # create MIME message
        self.kindle_email = self.kindle_email if not email else email
        ...
        try:
            ...
            traceback.print_exc()
            message = (
                "Communication with your SMTP server failed. Maybe "
